...
infected_years_file <- ffIn("Cumulative Infections/cum_inf_2020_eu1.tif")
...
infected_file <- ffIn("End of Year Infections/end_inf_2019_eu1.tif")
...
# save(sod_2020, file = "sod_2020.RData")


sod_2020_m <- sod_2020$posterior_means
sod_2020_cm <- sod_2020$posterior_cov_matrix
# 
# write.table(x = sod_2020_m, file = 'parameters/eu1_2020_means.csv', row.names = FALSE, col.names = FALSE)
# write.table(sod_2020_cm, 'parameters/eu1_2020_cov_mat.csv', row.names = FALSE, col.names = FALSE)