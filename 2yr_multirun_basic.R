...
host_file <- ffIn("Hosts/hosts_2020_2021.tif")
...
temp <- TRUE
temperature_coefficient_file <- ffIn("Weather/weather_coef_2020_2021.tif")
precip <- FALSE
...
management <- FALSE
treatment_dates <- c('2020-12-24', '2021-12-24')
treatments_file <- ffIn('Treatments/manage_2020.tif', 'Treatments/manage_2021.tif')
...
ic_inputs_file <- pops_multirun(infected_file,
                             host_file,
