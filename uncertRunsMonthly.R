uncertRunsMonthly <- function(case = 'all', months = 12){
  if (case == 'all'){
    ...
    colnames(out) <- c(rep(c('num all'), months), rep(c('area all'), months))
    return(out)
  }
  if (case == 'nohost'){
    initial_condition_uncertainty <- TRUE
    ...
    colnames(out) <- c(rep(c('num nohost'), months), rep(c('area nohost'), months))
    return(out)
  }
  if (case == 'noic'){
    ...
    colnames(out) <- c(rep(c('num noic'), months), rep(c('area noic'), months))
    return(out)
  }
  if (case == 'nopar'){
    initial_condition_uncertainty <- TRUE
    ...
    colnames(out) <- c(rep(c('num nopar'), months), rep(c('area nopar'), months))
    return(out)
  }
  if (case == 'host'){
    initial_condition_uncertainty <- FALSE
    ...
    colnames(out) <- c(rep(c('num host'), months), rep(c('area host'), months))
    return(out)
  }
  if (case == 'ic'){
    initial_condition_uncertainty <- TRUE
    ...
    colnames(out) <- c(rep(c('num ic'), months), rep(c('area ic'), months))
    return(out)
  }
  if (case == 'par'){
    initial_condition_uncertainty <- FALSE
    ...
    colnames(out) <- c(rep(c('num par'), months), rep(c('area par'), months))
    return(out)
  }
  if (case == 'none'){
    initial_condition_uncertainty <- FALSE
    ...
    colnames(out) <- c(rep(c('num none'), months), rep(c('area none'), months))
    return(out)
  }
}