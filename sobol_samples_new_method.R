...
#source pops_multirun_write.R

n <- 10 #number of iterations (individual realizations of PoPS)
...
#   }
#   
#   eu1_run <- pops_multirun_write(infected_file, #Changes here
#                                  host_file,
...
# }
# 
# eu1_start1 <- pops_multirun_write(infected_file, #Changes here
#                                host_file,
#                                total_populations_file,
#                                parameter_means,
#                                parameter_cov_matrix,
...
# }
# 
# eu1_start2 <- pops_multirun_write(infected_file, #Changes here
#                                   host_file,
#                                   total_populations_file,
#                                   parameter_means,
#                                   parameter_cov_matrix,
...
for(i in 1:n){
  outSims[[i]] <- pops_multirun_write(infected_file, #Changes here
                                    host_file,
                                    total_populations_file,
                                    parameter_means,
                                    parameter_cov_matrix,
