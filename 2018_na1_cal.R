...
infected_years_file <- ffIn("Cumulative Infections/cum_inf_2018_na1.tif")
...
infected_file <- ffIn("End of Year Infections/end_inf_2017_na1.tif")
...
save(sod_2018, file = "rdata/na1_2018.RData")

sod_2018_m <- sod_2018$posterior_means
sod_2018_cm <- sod_2018$posterior_cov_matrix

write.table(x = sod_2018_m, file = 'parameters/na1_2018_means.csv', row.names = FALSE, col.names = FALSE)
write.table(sod_2018_cm, 'parameters/na1_2018_cov_mat.csv', row.names = FALSE, col.names = FALSE)
