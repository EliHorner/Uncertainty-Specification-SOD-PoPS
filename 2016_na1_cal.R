...
infected_years_file <- ffIn("Cumulative Infections/cum_inf_2016_na1.tif")
...
infected_file <- ffIn("End of Year Infections/end_inf_2015_na1.tif")
...
sod_2016 <- calibrate(infected_years_file,
...
save(sod_2016, file = "rdata/na1_2016.RData")

sod_2016_m <- sod_2016$posterior_means
sod_2016_cm <- sod_2016$posterior_cov_matrix

write.table(x = sod_2016_m, file = 'parameters/na1_2016_means.csv', row.names = FALSE, col.names = FALSE)
write.table(sod_2016_cm, 'parameters/na1_2016_cov_mat.csv', row.names = FALSE, col.names = FALSE)
